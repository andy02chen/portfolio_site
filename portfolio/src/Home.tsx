        ...
        <div className='w-1/2 h-1/4 flex flex-row justify-center items-center gap-8'>
          <button className='cursor-pointer'>
            <svg width="339" height="76" viewBox="0 0 339 76" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M18 68L53.4921 8H335L295.251 68H18Z" fill="#FFD700" stroke="#FFD700" stroke-width="4"/>
              <path d="M1 75L44 1H67.5L24.5 75H1Z" fill="white" stroke="white"/>
              <text
                x="50%"
                y="55%"
                textAnchor="middle"
          ...
          <button className='cursor-pointer'>
            <svg width="325" height="83" viewBox="0 0 325 83" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 74.2651L39.4921 14.2651H321L281.251 74.2651H4Z" stroke="#FFD700" stroke-width="4"/>
