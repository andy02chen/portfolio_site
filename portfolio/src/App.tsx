    ...
    <main className="min-h-dvh w-full bg-[var(--dark-blue)] text-[var(--white)]">
      <nav className="font-ubuntu border-b border-[var(--light-yellow)]">
        ...
        <div className={`lg:hidden w-full p-4 
          ...
          {/* Menu */}
          { showHamburgerMenu && 
            <div className="w-full bg-[var(--dark-blue)] flex flex-col gap-4
            ">
              {/* Cross Button */}
              <button className="w-10 h-8"
                onClick={() => setShowHamburgerMenu(false)}
              >
                <svg className="h-full" viewBox="0 0 334 335" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul
  className="flex flex-col items-start justify-center gap-6 text-3xl text-[var(--white)] p-4"
>
  <li className="w-full flex items-center">
    <a href="#home" draggable="false" className="flex flex-row items-center gap-4">
  ...
  <li className="w-full flex items-center">
    <a href="#about_me" draggable="false" className="flex flex-row items-center gap-4">
      <div className="h-12 w-12 flex-shrink-0">
  ...
  <li className="w-full flex items-center">
    <a href="#projects" draggable="false" className="flex flex-row items-center gap-4">
      <div className="h-12 w-12 flex-shrink-0">
  ...
  <li className="w-full flex items-center">
    <a href="#contact" draggable="false" className="flex flex-row items-center gap-4">
      <div className="h-12 w-12 flex-shrink-0">
